...
public class ControlEndPoint {
    ...
    public String toString() {
        ...
        sb.append(ControlEndPoint.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ControlEndPoint) == false) {
            return false;
        }
        ControlEndPoint rhs = ((ControlEndPoint) other);
        return ((((((((this.endPointURI == rhs.endPointURI)||((this.endPointURI!= null)&&this.endPointURI.equals(rhs.endPointURI)))&&((this.protocol == rhs.protocol)||((this.protocol!= null)&&this.protocol.equals(rhs.protocol))))&&((this.endPointCertificate == rhs.endPointCertificate)||((this.endPointCertificate!= null)&&this.endPointCertificate.equals(rhs.endPointCertificate))))&&((this.mQTTQoS == rhs.mQTTQoS)||((this.mQTTQoS!= null)&&this.mQTTQoS.equals(rhs.mQTTQoS))))&&((this.accessToken == rhs.accessToken)||((this.accessToken!= null)&&this.accessToken.equals(rhs.accessToken))))&&((this.endPointID == rhs.endPointID)||((this.endPointID!= null)&&this.endPointID.equals(rhs.endPointID))))&&((this.encryptionEnforced == rhs.encryptionEnforced)||((this.encryptionEnforced!= null)&&this.encryptionEnforced.equals(rhs.encryptionEnforced))));
    }
